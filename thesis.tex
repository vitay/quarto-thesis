...
See Figure~\ref{fig-dopamine}, Section~\ref{sec-admonitions} and
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, coltitle=black, breakable, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota Bene}, left=2mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colframe=quarto-callout-note-color-frame]
